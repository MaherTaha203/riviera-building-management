...
function RivieraLogo() {
  return (
    <div className="flex flex-col items-center" aria-label="Riviera Building Management">
      <div className="font-['Playfair_Display',Georgia,serif] text-[64px] font-bold leading-none text-[#22A277]">
        R
      </div>
      <div className="mt-2.5 font-[Inter] text-[28px] font-bold leading-none tracking-[0.34em] text-[#1A1C21]">
        RIVIERA
      </div>
      <div className="mt-1.5 font-[Inter] text-[11px] font-semibold tracking-[0.42em] text-[#22A277]">
        BUILDING MANAGEMENT
      </div>
      <span className="my-[26px] h-px w-[72px] bg-gradient-to-l from-transparent via-[#22A277] to-transparent" />
    </div>
  );
}
...
export default function Login() {
  ...
  const inputBaseClass =
    ...
    "focus-visible:border-[#22A277] focus-visible:ring-4 focus-visible:ring-[#22A277]/15";
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#F7F8FA]">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(120%_120%_at_85%_5%,#EDEFF2_0%,transparent_45%),radial-gradient(100%_100%_at_5%_95%,#EBEDF0_0%,transparent_50%)]" />

        {/* blurred champagne blobs (physical positions per the reference) */}
        <div className="absolute -top-[160px] -right-[120px] h-[420px] w-[420px] rounded-full bg-[#E6E8EC] opacity-[0.65] blur-[70px]" />
        <div className="absolute -bottom-[140px] left-[22%] h-[380px] w-[380px] rounded-full bg-[#E7F4EE] opacity-60 blur-[70px]" />

        {/* thin gold rings */}
        <div className="absolute -top-[230px] -left-[180px] h-[540px] w-[540px] rounded-full border-[1.5px] border-[#22A277]/[0.22]" />
        <div className="absolute -bottom-[280px] -right-[200px] h-[620px] w-[620px] rounded-full border-[1.5px] border-[#22A277]/[0.22]" />
      </div>
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[1160px] flex-col items-center justify-center gap-16 px-6 py-16 lg:flex-row lg:gap-20 lg:px-10">
        ...
        <section className="flex w-full flex-col items-center text-center duration-700 animate-in fade-in slide-in-from-bottom-4 motion-reduce:animate-none lg:w-[45%]">
          ...
          <h1 className="text-[32px] font-bold leading-snug text-[#1A1C21]">
        ...
        <section className="flex w-full justify-center lg:w-[55%]">
          <div className="relative w-[460px] max-w-full pt-9">
            ...
            <div className="absolute start-1/2 top-0 z-20 flex h-[72px] w-[72px] -translate-x-1/2 items-center justify-center rounded-full border border-white/70 bg-white shadow-[0_18px_40px_rgba(16,42,67,0.12)] rtl:translate-x-1/2">
              <Lock className="!h-7 !w-7 text-[#22A277]" strokeWidth={2.2} />
            </div>
            ...
            >
              <div className="mb-8 text-center">
                <h2 className="text-2xl font-bold text-[#1A1C21]">تسجيل الدخول</h2>
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <button
                              ...
                              className="absolute end-3 top-1/2 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full text-[#94A3B8] transition-colors hover:bg-[#EDEFF2] hover:text-[#1A1C21] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#22A277]/40"
                            >
                              {showPassword ? (
                  ...
                  <Button
                    ...
                    className={cn(
                      "mt-1 h-14 w-full rounded-2xl bg-[#22A277] text-base font-semibold text-white",
                  ...
                  {isPending && (
                    <div aria-live="polite">
                      ...
                      >
                        <div className="rv-indeterminate-bar h-full w-1/3 rounded-full bg-[#22A277]" />
                      </div>
